...
const createdBy = 'created_by.id,created_by.screen_name,created_by.first_name,created_by.last_name,created_by.avatar.filename';
const user = 'user.id,user.screen_name,user.first_name,user.last_name,user.avatar.filename';
